...
import data from '../../../datas/dataFootwear'
    ...
    <div {...document.body.style.overflowY = "scroll"}>
      <nav className={`flex text-black justify-between text-center p-6 absolute z-10 w-full px-10`}>
          <div className='lg:flex lg:gap-3'>
            ...
            <Link to='/E-commerce'><img className='hidden mb:flex brightness-0' src={ Logo1 } alt=''/></Link>
            <div className='flex gap-3'>
              <a  href="/footwear">
                <UserIcon className='w-[24px] hover:hover:text-red-500'/>
              </a>
              <a  href="/footwear">
                <MagnifyingGlassIcon className='w-[24px] hover:hover:text-red-500'/>
              </a>
              <Link to='/shop'>
                <ShoppingBagIcon  className='w-[24px] hover:hover:text-red-500'/>
              </Link>
            </div>
        </nav>
      ...
      <div className='pt-40 mb-12'>
        <h1 className='text-black m-5 text-2xl lg:ml-10 lg:text-4xl sm:text-4xl sm:ml-9 sm:mt-10 mb:text-3xl mb:m-5'>Footwear</h1>
