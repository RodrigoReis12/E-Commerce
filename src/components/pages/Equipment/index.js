...
import data from '../../../datas/dataEquipment';
  ...
  return (
    <div {...document.body.style.overflowY = "scroll"}>
      ...
      <div className='pt-40 mb-12'>
        <h1 className='text-black m-5 text-2xl lg:ml-10 lg:text-4xl sm:text-4xl sm:ml-9 sm:mt-10 mb:text-3xl mb:m-5'>Equipment</h1>
